  ...
  jQuery(function($) {
    ...
    FilePicker = (function() {
      ...
      FilePicker.prototype.display = function() {
        ...
        if ($('input.name').val() === this._previous_filename) {
          return this._form.find('input.name').val(this._filename);
        }
      };
    ...
    Folder = (function() {
      ...
      Folder.prototype.set = function(e) {
        ...
        this._state = typeof localStorage !== "undefined" && localStorage !== null ? localStorage.getItem("show_folder_" + this._label) : void 0;
      ...
      Folder.prototype.show = function(e) {
        ...
        if (typeof localStorage !== "undefined" && localStorage !== null) {
          localStorage.setItem("show_folder_" + this._label, "open");
        }
        this._container.addClass('open');
      ...
      Folder.prototype.hide = function(e) {
        ...
        if (typeof localStorage !== "undefined" && localStorage !== null) {
          localStorage.setItem("show_folder_" + this._label, "closed");
        }
