  ...
  DragManager = (function () {
    ...
    DragManager.prototype.possibleDrop = function (e) {
      ...
      if (this.del && this.confirmDrop(this.del)) {
        this.enactDrop(this.del, this.el)
          .done(this.dropSuccess)
          .fail(this.dropFail);
        merging = true;
      }
    ...
    DragManager.prototype.startListening = function () {
      $(document)
        ...
        .on('mouseup', this.possibleDrop);
      return this.draggables
        .on('mouseenter', this.droppable)
        .on('mouseleave', this.undroppable);
    };

    DragManager.prototype.stopListening = function () {
      $(document)
        .off('mousemove', this.dragMove)
        .off('mouseup', this.possibleDrop);
      return this.draggables
        .off('mouseenter', this.droppable)
        .off('mouseleave', this.undroppable);
    };
